...
import QuestionView from "../../Component/Profile/QuestionView";
import AnswerView from "../../Component/Profile/AnswerView";
...
const Page = (location) => {
 ...
 <div className="flex gap-4 h-screen w-full">
   ...
   <div className="flex flex-col h-full w-full">
     {showProfileComplete && (
       <ProfileUpdate handleProfileFun={handleProfileClick} />
      )}
