...
const Skeleton_Question = () => {
  // Generate an array of length 5 for the skeleton items
    ...
    <div className="flex flex-col w-full gap-4">
      {skeletonItems.map((index) => (
        <div
          key={index}
          role="status"
          className="bg-white rounded-xl w-full h-fit py-8 px-4 space-y-8 animate-pulse flex items-center gap-4"
        >
...
export default Skeleton_Question;
